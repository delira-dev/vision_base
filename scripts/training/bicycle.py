from deliravision.models.gans import BiCycleGAN, create_optims_bicycle_gan
...
def train_bicycle(params, dset, save_path):
    img_size = params.nested_get("img_size")
    dset_train = TorchvisionClassificationDataset(dset, img_shape=(img_size,
                                                                   img_size))
    ...
    exp = PyTorchExperiment(params, model_cls=BiCycleGAN,
                            n_epochs=params.nested_get("n_epochs"),
                            save_path=save_path,
                            optim_builder=create_optims_bicycle_gan)
...
if __name__ == '__main__':
    ...
    train_bicycle(params, args.dataset, args.savepath)
