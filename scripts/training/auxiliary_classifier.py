...
def train_aux_clf(params, dset, save_path):
    ...
    exp = PyTorchExperiment(params, model_cls=AuxiliaryClassifierGANPyTorch,
...
if __name__ == '__main__':
    ...
    train_aux_clf(params, args.dataset, args.savepath)
